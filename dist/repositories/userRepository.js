...
var findUserByEmailAndPassword = function (email, password) { return __awaiter(void 0, void 0, void 0, function () {
...
var deleteById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, user_1.default.findByIdAndRemove(id)];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
var updateUser = function (id, user) { return __awaiter(void 0, void 0, void 0, function () {
    var updateOps, _i, user_2, ops;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                updateOps = {};
                for (_i = 0, user_2 = user; _i < user_2.length; _i++) {
                    ops = user_2[_i];
                    updateOps[ops.propName] = ops.value;
                }
                return [4 /*yield*/, user_1.default.update({ _id: id }, { $set: updateOps })];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
